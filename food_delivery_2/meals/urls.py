...
from .views import home, user_logout, meal_order_info, subscription_plans, signup, user_login, meal_off, meal_off_success, subscribe, consume_meal, subscription_success, consume_meal_success, invalid_meal_time, order_statistics_view
...
urlpatterns = [
    ...
    path('meal-order-info/', meal_order_info, name='meal_order_info'),
]
